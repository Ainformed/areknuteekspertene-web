  ...
  return (
    <div className="min-h-screen">
      ...
      <header className={`header ${isScrolled ? "header-scrolled" : ""}`}>
        <div className="container-wide py-6 md:py-5 flex justify-between items-center">
      ...
      <section className="bg-gradient-hero min-h-[auto] md:min-h-screen flex items-center pt-24 pb-8 md:pt-20 md:pb-16 relative overflow-hidden">
        ...
        <div className="container-wide relative z-10">
          ...
          <div className="max-w-xl">
            ...
            {/* Mobile Hero Image */}
            <div className="lg:hidden relative my-6 animate-fade-in">
              <div className="relative">
                <img
                  ...
                  className="rounded-2xl shadow-lg w-full aspect-[4/3] object-cover object-[center_20%]"
                />
                <div className="absolute bottom-3 right-3 bg-white/95 backdrop-blur rounded-xl shadow-md px-4 py-2.5">
      ...
      {/* Footer */}
      {/* Maps Section */}
      <section className="bg-[var(--color-cream-dark)] py-12 md:py-16">
        <div className="container-wide">
          <h2 className="text-2xl md:text-3xl text-[var(--color-charcoal)] text-center mb-8">Våre klinikker</h2>
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            {/* Oslo */}
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[var(--color-cream-dark)]">
              <iframe
              ...
              <div className="p-4 md:p-5">
                <h3 className="text-[var(--color-charcoal)] font-medium text-lg mb-1">Oslo</h3>
                <p className="text-[var(--color-charcoal-light)] text-sm mb-3">Sørkedalsveien 10A, 0369 Oslo</p>
                <a
                  href="https://www.google.com/maps/dir//S%C3%B8rkedalsveien+10A,+0369+Oslo"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-[var(--color-forest)] hover:text-[var(--color-forest-light)] text-sm font-medium transition-colors"
                >
                  <MapPinIcon />
                  Få veibeskrivelse
                </a>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[var(--color-cream-dark)]">
              ...
              />
              <div className="p-4 md:p-5">
                <h3 className="text-[var(--color-charcoal)] font-medium text-lg mb-1">Tromsø</h3>
                <p className="text-[var(--color-charcoal-light)] text-sm mb-3">Storgata 94, 9008 Tromsø</p>
                <a
